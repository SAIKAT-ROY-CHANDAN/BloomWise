    ...
    return (
        <div className="group relative z-0 transition-all focus-within:z-10">
            <input
                ...
                {...props}
                placeholder=" "
                className="peer block w-full border border-neutral-300 dark:border-neutral-600 bg-transparent dark:bg-zinc-950 px-6 py-3 text-base/6 text-neutral-950 dark:text-neutral-50 ring-4 ring-transparent transition focus:border-neutral-950 dark:focus:border-neutral-50 focus:outline-none focus:ring-neutral-950/5 dark:focus:ring-neutral-50/5 group-first:rounded-t-md group-last:rounded-b-md"
            />
            <label
                htmlFor={id}
